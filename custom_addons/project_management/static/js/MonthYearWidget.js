...
odoo.define('project_management.month_year_picker', function (require) {
    "use strict";
    ...
    // Widget 'month_year_picker' to be added from the xml at field declaration
    ...
    fieldRegistry.add('month_year_picker', MonthYearFormatFieldDate);
